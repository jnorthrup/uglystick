...
export default function LLMPanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-panel border-l border-border/40 w-80 shrink-0 overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-border/30 bg-panel-header shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-mono text-purple-400/70 bg-purple-500/10 px-1.5 py-0.5 rounded-full border border-purple-500/20">
            GRAPHIQUE AI
          </span>
        </div>
        <div className="flex items-center gap-1">
          <Button
            ...
            className={`w-6 h-6 ${view === "settings" ? "text-amber-400" : "text-muted-foreground"}`}
          >
          ...
          <Button
            ...
            className="w-6 h-6 text-muted-foreground/40 hover:text-muted-foreground"
          >
            <X className="w-3 h-3" />
          </Button>
        </div>
